...
// Next two extract userID, but redirect to different pages
const isLoggedMW = function(req, res, next) {
  req.id = users.isUser(req.session.userID);
...
app.get('/urls/:shortURL',                        // '/urls/:shortURL'
  isAuthorizedMW, (req, res) => {
